...
public class InstAuthButtonComponent extends UIBean {
	
	private String authCode;
	private String disabledFlag;
	
	public InstAuthButtonComponent(ValueStack stack, HttpServletRequest request,
	...
	protected void evaluateExtraParams() {
		...
		addParameter("hasInstAuthButton", instSess.hasInstAuth(authCode));
	}

...
@StrutsTag(
	    name="submit",
	    tldTagClass="newland.base.views.tags.HcSubmitTag",
	    description="Render a submit button",
	    allowDynamicAttributes=true)
public class HcSubmitComponent extends FormButton{

	 private static final Logger LOG = LoggerFactory.getLogger(HcSubmitComponent.class);
	    final public static String OPEN_TEMPLATE = "submit";
	    final public static String TEMPLATE = "submit-close";
	    protected String src;
	    protected String authCode;

	    public HcSubmitComponent(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
	    ...
	    public void evaluateExtraParams() {
			...
			//addParameter("hasSubmitAuth", iafConsoleSession.hasHcAuth(authCode));
			if(!iafConsoleSession.hasHcAuth(authCode)){

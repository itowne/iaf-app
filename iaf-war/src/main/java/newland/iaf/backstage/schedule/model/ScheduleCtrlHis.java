...
public class ScheduleCtrlHis implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	@Id
	@Column (name = "i_sch_his")
	@TableGenerator(name = "i_sch_his", initialValue = 0, allocationSize = 100)
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "i_sch_his")
	private Long isch;
	/**
	 * 定时器名称
	 */

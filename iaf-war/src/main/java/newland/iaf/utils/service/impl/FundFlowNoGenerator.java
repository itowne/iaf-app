 ...
 * @author lance
 */
@Service(value = "fundFlowNoGenerator")
public class FundFlowNoGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "FUND_FLOW_NO";
	...
	public FundFlowNoGenerator() {
		this(MAXLENGTH);
	}

	protected FundFlowNoGenerator(int maxLength) {

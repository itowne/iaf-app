 ...
 * @author lance
 */
@Service(value = "transLogNoGenerator")
public class TransLogNoGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "TRANS_LOG_NO";
	...
	public TransLogNoGenerator() {
		this(MAXLENGTH);
	}

	protected TransLogNoGenerator(int maxLength) {

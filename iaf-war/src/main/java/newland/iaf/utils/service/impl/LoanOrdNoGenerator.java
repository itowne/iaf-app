...
@Service("loanOrdNoGenerator")
public class LoanOrdNoGenerator extends HiLoIdGenerator implements
		IdentifierGenerator {

	private static final String IDGEN_NAME = "ORDE_NO";

	Logger logger = LoggerFactory.getLogger(LoanOrdNoGenerator.class);
	...
	public LoanOrdNoGenerator() {
		this(MAXLENGTH);
	}

	protected LoanOrdNoGenerator(int maxLength) {

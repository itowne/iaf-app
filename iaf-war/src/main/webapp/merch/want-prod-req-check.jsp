...
<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content" class="report">
				...
				<div class="report-tab-area">
					...
					<h3 style="line-height:42px;text-align:center;font-size:15px;">贷款申请时，请补充以下的企业基本资料：</h3>
		...
		function sub(){
			...
			window.location.href="${ctx}/merch/merchProdReq!saveCheck?merchName="+merchName+'&code='+code;
		}
		$(function(){

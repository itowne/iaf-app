...
<body>
				...
				<div class="search-bar">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						<tr>
							...
							<td>
							<s:form target="" action="merchCreditReport">
		...
		<s:form target="" id="viewForm" action="merchCreditReport!viewReport">
			<input type="hidden" id="index1" name="index"></input>
		</s:form>
		<s:form target="" id="downloadForm" action="merchCreditReport!download">
			<input type="hidden" id="index2" name="index"></input>
		</s:form>
		<s:form target="" id="deleteForm" action="merchCreditReport!deleteReport">
			<input type="hidden" id="index3" name="index"></input>
		</s:form>
		<script type="text/javascript">
			...
			function getList(){
				jQuery("#list").jqGrid({
					url:'${ctx}/merch/merchCreditReport!list',
			...
			function optionFormatter(cellvalue, options, rowObject){
				...
				return '[<a href="JavaScript:download('+index+');">下载</a>]&nbsp;&nbsp;[<a href="JavaScript:viewReport('+index+');">查看</a>]&nbsp;&nbsp;[<a href="JavaScript:deleteReport('+index+');">删除</a>]';
			}

...
<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content" class="report">
				...
				<div class="report-tab-area">
					...
					<h3 style="line-height:42px;text-align:center;font-size:15px;">资料修改成功！</h3>
		...
		<script type="text/javascript">
			...
			function close(){
				window.parent.location.href="${ctx}/merchLogin!init?target=/merch/merchProdReq!wantProdReq?index="+index;
			}
		</script> 

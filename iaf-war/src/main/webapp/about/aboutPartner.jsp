...
<html>
	...
	<div id="main" class="iaf-grid">
            ...
            <div id="main-con">
				...
				<h3 class="title"><em>合作伙伴</em></h3>
				<p><img style="border:1px solid #999999;" src="../resources/images/portal/ap1.jpg" width="715" height="338" alt=""></p>
				<p><img style="border:1px solid #999999;" src="../resources/images/portal/ap2.jpg" width="715" height="300" alt=""></p>
				<p><img style="border:1px solid #999999;" src="../resources/images/portal/ap3.jpg" width="715" height="128" alt=""></p>
			</div>
			<div class="clear"></div>
		</div>

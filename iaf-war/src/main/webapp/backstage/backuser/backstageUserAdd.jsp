...
<html>
	<body>
		...
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content">
				<h3 class="title"><span>新增详细信息</span></h3>
				...
				<s:form id="instform" action="backUserManager" namespace="/backstage/backuser" enctype="multipart/form-data">
					<table width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						...
						<tr>
							...
							<td class="data"><input  name="backStageUser.loginName" class="validate[required]" value="<s:property  value='backStageUser.loginName'/>" /><font color=red>*</font></td>
						...
						<tr>
							...
							<td class="data"><input type="password" class="validate[required]" name="password" /></td>
							<td class="label">确认新密码：</td>
							<td class="data"><input type="password" class="validate[required]" name="passwordAgain" /></td>
						</tr>
						<tr>
					...
					<div class="uop">
						<s:submit cssClass="dark-btn" value="保存" method="saveBackstageUser" onclick="return checkForm()"/>
		...
		function checkForm(){
			...
			function back(){
				window.location.href="${ctx}/backstage/backuser/backUserManager";
			}

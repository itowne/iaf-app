...
<html>
	<body>
		<div id="workframe-wrapper" class="clearfix">
			<div id="location">
				<p>当前位置：系统参数设置&nbsp;&gt;&gt;&nbsp;交易记录FTP设置</p>
			</div>
			<div id="content">
				<h3 class="title"><span>交易记录FTP设置</span></h3>
				...
				<s:form id="instform" action="sysParam" namespace="/backstage/sysparam" >
					<table width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						<tr>
							<td class="data" colspan="4">交易记录文件的FTP访问路径及账号密码设置：</td>
						</tr>
						<tr>
					...
					<div class="uop">
						<s:submit cssClass="dark-btn" value="保存" method="updateTransLog" onclick="return checkForm();"/>
					</div>
					</s:form>
					<div class="results report">

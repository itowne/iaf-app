...
<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content" class="report">
				...
				<div class="report-tab-area">
					...
					<h3 style="line-height:42px;text-align:center;font-size:15px;"><font style="color:red">补充资料概述不得超过500个字!</font></h3>
					<div style="margin: 20px" align="center">
					<a  class="dark-btn" href="JavaScript:close();" >返&nbsp;&nbsp;&nbsp;&nbsp;回</a>
					</div>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript">
			...
			function close(){
				window.location.href="/backstage/merchcreditreport/backMerchCredit!viewPagePositon.action?method:viewPagePosition&position=OTHER_INFO&instType=HICARD";
			}
		</script> 

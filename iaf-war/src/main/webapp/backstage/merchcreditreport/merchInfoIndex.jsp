	...
	<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content">
				...
				<s:form id="merchMainForm" action="backMerchCredit" namespace="/backstage/merchcreditreport">
		...
		<script type="text/javascript">
			...
			function getList(){
				jQuery("#list").jqGrid({
					...
					colModel:[
// 						{name:'imerch',index:'imerch',align:"center", width:90},
						...
						{name:'contract',index:'contract',align:"center", width:55},
						{name:'contractTel',index:'contractTel',align:"center", width:55},
			...
			function operFormatter(cellvalue, options, rowObject){
				var id = "'"+rowObject[6]+"'";
				return '[<a href="JavaScript:userDetail('+id+');">商户经营数据报告</a>]';
			}
			...
			function userDetail(index){
				document.merchMainForm.action="${ctx}/backstage/merchcreditreport/backMerchCredit!creditIndex?imerch="+index;	

...
<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content" class="report">
				...
				<div class="report-tab-area">
					...
					<h3 style="line-height:42px;text-align:center;font-size:15px;">添加成功！</h3>
		...
		<script type="text/javascript">
			...
			function close(){
				window.location.href="/backstage/merchcreditreport/backMerchCredit!viewPagePositon.action?method:viewPagePosition&position=MERCH_BUSI_DATA_VERIFICATION&instType=HICARD";
			}
		</script> 

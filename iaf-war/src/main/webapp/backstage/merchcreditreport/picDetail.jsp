				...
				<div class="report-tab-area">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"class="data-table" align="center">
						...
						<table width="100%" border="0" style=" border-width:0px" cellspacing="0" cellpadding="0"class="" >
								<s:iterator value="#session.otherFiles" id="tfiles" status="status">
						...
						<td class="data" colspan="2">
						<s:if test="#session.otherFiles.size>0">
	...
	<script type="text/javascript">
		...
		function remove(id){
			if(confirm("确认要删除此图片吗?")){
				window.location.href="${ctx}/backstage/merchcreditreport/backMerchCredit!deletePic.action?ifile="+id;
			}
		}
	</script>

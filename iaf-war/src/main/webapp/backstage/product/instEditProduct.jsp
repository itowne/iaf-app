...
<head>
	...
	<body>
				...
				<s:form id="instprodform" action="instProduce" namespace="/backstage/product" method = "post" enctype="multipart/form-data">
					<table width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						<tr>
							...
							<td class="data"><input  name="loanPdt.pdtName"  class="validate[required,minSize[2]]" value="<s:property  value='loanPdt.pdtName'/>"  maxLength="30"/><font color=red>*</font></td>
							<td class="label">最快放款时间</td>
							<td class="data"><input  name="loanPdt.creditTerm" class="validate[required,[custom[integer]],min[1]" value="<s:property  value='loanPdt.creditTerm'/>"  maxLength="15"/>（天）<font color=red>*</font></td>
						</tr>
						<tr>
							<td class="label">贷款最低金额</td>
							<td class="data"><input id="minQuota" name="loanPdt.minQuota" class="validate[required,[custom[integer]],min[1]" value="<s:property  value='loanPdt.minQuota'/>" />（万元）<font color=red>*</font></td>
							<td class="label">贷款最高金额</td>
							<td class="data"><input id="maxQuota" name="loanPdt.maxQuota" class="validate[required,[custom[integer]],min[1]" value="<s:property  value='loanPdt.maxQuota'/>" />（万元）<font color=red>*</font></td>
						</tr>
						<tr>
							<td class="label">贷款最短周期</td>
							<td class="data"><input id="minTerm" style="width:60px" name="loanPdt.minTerm" class="validate[required,[custom[integer]],min[1]" value="<s:property  value='loanPdt.minTerm'/>" />
							...
							<td class="data"><input id="maxTerm" style="width:60px" name="loanPdt.maxTerm" class="validate[required,[custom[integer]],min[1]" value="<s:property  value='loanPdt.maxTerm'/>" />
						...
						<tr>
							...
							<td class="data" colspan="3"><textarea  class="validate[required,maxSize[20]]" name="loanPdt.introduce" rows="1" cols="71"><s:property value='loanPdt.introduce'/></textarea><font color=red>*</font></td>
						</tr>
						<tr>
							<td class="label">产品特点</td>
							<td class="data" colspan="3"><textarea class="validate[maxSize[1000]]" name="loanPdt.feature"  rows="15" cols="71"><s:property value='loanPdt.feature'/></textarea><font color=red>*</font></td>
						</tr>
						<tr>
							<td class="label">申请条件</td>
							<td class="data" colspan="3"><textarea class="validate[maxSize[1000]]" name="loanPdt.condition"  rows="15" cols="71"><s:property value='loanPdt.condition'/></textarea><font color=red>*</font></td>
						</tr>
						<tr>
							<td class="label">申请所需材料</td>
							<td class="data" colspan="3"><textarea class="validate[maxSize[1000]]" name="loanPdt.cl" rows="15" cols="71"><s:property value='loanPdt.cl'/></textarea><font color=red>*</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<s:file id="fileforload" name="upload" label="File"/>&nbsp;&nbsp;&nbsp;(建议上传150X70的图片,此图片将用于平台"我要借款"频道上显示)</td>
						</tr>
						<tr>
							<td class="label">产品LOGO小图片</td>
							<td class="data" colspan="4">
							<s:hidden id="PdtLogoPage" name="filetype" value="PdtLogoPage"/>
							<s:file id="pdtfile" name="upload" label="File"/>&nbsp;&nbsp;&nbsp;(建议上传45X45的图片,此图片将用于平台"首页"频道上显示)</td>
						</tr>
					</table>
					<div class="uop">
						<n:HcAuthButton cssClass="dark-btn" value="确定" onclick="return doSubmit();" authCode="HDCP_XG"/>
		...
		function doSubmit(){
			...
			document.instprodform.action="${ctx}/backstage/product/instProduce!updateProduct";	

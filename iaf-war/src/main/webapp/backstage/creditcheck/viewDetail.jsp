...
<base target="_self"/>
	<body>
	<s:form id="form" target="" action="creditCheck">
	 <div id="content" class="report">
	<h3 style="line-height:32px;text-align:center;font-size:15px;">放款交易对账详情</h3>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="data-table">
    	...
    	<tr>
    		<td class="label" width="100">放款金额(元)</td>
    		<td class="data"><s:label name="loanOrd.quota"/></td>
    		<td class="label" width="100">交易手续费(元)</td>
    		<td class="data"><s:label name="charge"/></td>
    	</tr>
    	 <tr>
    	...
    	<tr>
    	 ...
    	 <tr>
    		...
    		<td class="data"><s:if test='fundFlow.status.toString()=="AUDIT"'>
    		未对账
    		</s:if>
    		<s:else>
    	...
    	<tr>
    		...
    		<s:if test='fundFlow.status.toString()=="SUCCESS"||fundFlow.type.toString()=="OTH_CREDIT"||fundFlow.status.toString()=="EXPIRY"'>
    ...
    <div style="margin:15px auto;text-align:center;">
    	...
    	<s:else>
    	<n:HcAuthButton value="已对账"  cssClass="dark-btn" onclick="return beforeSubmit1('是否提交？','audit');" authCode="FKDZ_YDD"/>
   		<n:HcAuthButton value="退  款"  cssClass="dark-btn" onclick="return beforeSubmit1('是否提交？','cancel');" authCode="FKDZ_TH"/>
   		<n:HcAuthButton value="下载对账文件" onclick="down()" cssClass="dark-btn" authCode="FKDZ_XZ"/>
	...
	<script type="text/javascript">
	    function close1(){
	    	...
	    	//window.location.href="${ctx}/backstage/creditCheck";
	    	return false;
	    }
	    function download(){
	    	window.open("${ctx}/backstage/creditCheck!downloadOrd.action?method:downloadOrd");
	    	return false;
	    }
		...
		function beforeSubmit1(str,method){
			if (confirm(str)){
				...
				document.form.action="${ctx}/backstage/creditCheck!"+method;	
		...
		function down(){
				document.form.action="${ctx}/backstage/creditCheck!downloadOrd";	
		        document.form.submit();
		}
	</script>

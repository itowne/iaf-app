...
<jsp:include page="${ctx}/template/head.jsp" />
	<body>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="data-table">
											...
											<td class="label">类型</td>
												...
												<select name="type" id="type">
													...
													<option value="REFUND">平台内还款</option>
													<option value="OTH_REFUND">平台外还款</option>
												</select></td>
											</tr>
										</table>
									</td>
		...
		<script type="text/javascript">
			...
			function getList(){
				jQuery("#list").jqGrid({
					url:'${ctx}/backstage/refundMgr!list',
					colNames:['编号','借贷编号','商户名称','机构名称','入账时间','还款金额','类型','操作'],
					colModel:[
						...
						{name:'amount',index:'amount',align:"center",formatter:optionFormatter2, width:45},
			...
			function viewFundFlowDetail(rowId){
				window.location = "${ctx}/backstage/refundMgr!viewFundFlowDetail?index=" + rowId;
			}
			function storeQuery(){
				...
				var type=$("#type").val();
				$("#list").jqGrid('setGridParam',{url:'${ctx}/backstage/refundMgr!list?loanOrdId='+loanOrdId+'&instName='+encodeURI(instName)+'&merchName='+encodeURI(merchName)+'&type='+type,page:1}).trigger("reloadGrid");
			}
		</script>

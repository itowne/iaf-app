...
<head>
	...
	<body>
		<div id="workframe-wrapper" class="clearfix">
			<div id="location">
				<p>当前位置：公告管理&nbsp;&gt;&gt;&nbsp;新增公告信息</p>
			</div>
			<div id="content">
				<h3 class="title"><span>新增公告信息</span></h3>
				...
				<s:form id="notifyform"  action="notifyManager" namespace="/backstage/notifymanager">
					<table width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						...
						<tr>
							...
							<td class="data" colspan="3"><textarea id="cont" class="validate[required,maxSize[1000]]" name="instNotice.content"></textarea></td>
						</tr>
						
					</table>
					<div class="uop">
						<s:submit cssClass="dark-btn" value="保存" method="saveNotify" onclick="return checkForm();"/>

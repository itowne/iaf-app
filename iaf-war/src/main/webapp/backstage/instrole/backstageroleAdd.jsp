	...
	<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content">
				...
				<s:form id="roleForm" action="/backstage/instmanager/instRole!instRoleAdd" onsubmit="return checkform();">
					<table id="addRole" width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						<tr>
							<td class="label">角色名称：</td>
							<td class="data"><s:textfield id="roleName" name="roleName" maxLength="30" cssClass="validate[required,minSize[2]]"/><font color=red>*<s:property value="%{roleNameError}"/></font>
							<span id="msg"></span></td>
						</tr>
						<tr>

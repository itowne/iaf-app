...
<html>
	...
	<body>
		<div id="workframe-wrapper" class="clearfix">
			<div id="location">
				<p>当前位置：系统管理&nbsp;&gt;&gt;&nbsp;角色管理&nbsp;&gt;&gt;&nbsp;角色详情</p>
			</div>
			<div id="content">
				<h3 class="title"><span>角色详细信息</span></h3>
				...
				<s:form id="roleForm" action="backstageRole" namespace="/backstage/backstagerole">
					<table width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						<tr>
							...
							<td class="data"><s:textfield id="role_Name" name="bsRoleAuth.roleName" maxLength="30" readonly="true"/><font color=red>*</font>
							</td>
						</tr>
						<!-- 
						<tr>

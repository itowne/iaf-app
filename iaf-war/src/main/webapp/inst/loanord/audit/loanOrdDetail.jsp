...
<body>
<s:form action="prodAudit">
<div id="workframe-wrapper" class="clearfix">
  <div id="location">
    <p>当前位置：审批处理&nbsp;&gt;&gt;&nbsp;受理进度情况</p>
  </div>
  <div class="how-to-ask">
  	<strong>借贷处理流程：</strong>&nbsp;<img src="/resources/images/mp/bg-step2.gif" width="737" height="24" alt=""/>
  </div>
  <div class="report-tab-area">
    ...
    <div id="content" class="report">
	    ...
	    <table width="550" border="0" cellspacing="0" cellpadding="0" class="data-table">
	    	<tr>
	    	<td><s:textarea name="memo" value="" cols="75" rows="5"></s:textarea></td>
	    	</tr>
	    </table>
	    <div style="margin:15px auto;text-align:center;">
	    	
	    		<s:submit method="audit" cssClass="dark-btn" value="审核通过" onclick="return beforeSubmit('是否通过该订单审核');" />
	    		<s:submit method="refuse" cssClass="dark-btn" value="审核不通过"  onclick="return beforeSubmit('是否拒决该订单？');"/>
	    		<s:submit method="cancel" cssClass="dark-btn" value="作废订单" onclick="return beforeSubmit('是否作废该订单？');" />

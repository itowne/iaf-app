...
<body>
		...
		<script type="text/javascript">
			...
			function close(){
				window.location.href="/inst/loanord/merchCreditReport!viewPagePositon.action?method:viewPagePosition&position=MERCH_BUSI_DATA_VERIFICATION&instType=INST";
			}
		</script> 

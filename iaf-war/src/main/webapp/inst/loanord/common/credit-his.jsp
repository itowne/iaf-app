...
<body>
		...
		<s:form target="_self" id="viewForm" action="merchCreditReport!viewReport">
			<s:hidden id="index1" name="index"></s:hidden>
		</s:form>
		<s:form target="" id="downloadForm" action="merchCreditReport!download">
			<s:hidden id="index2" name="index"></s:hidden>
		</s:form>
		<script type="text/javascript">
			...
			function getList(){
				jQuery("#list").jqGrid({
					url:'${ctx}/inst/loanord/merchCreditReport!list',

...
<div id="workframe-wrapper" class="clearfix">
  ...
  <div align="center" style="font-size:16px;font-weight: bold;color:red">  请上传已盖公司印章的冻结申请凭证扫描图片。我们会尽快进行审核和清算资金的冻结，并且成功冻结的清算资金会自动汇到您的放贷专用账号上，请注意查收。</div>
  <div id="content" class="report" align="center" style="margin-top: 20px">
   		
  </div>
  </form>
<script type="text/javascript">
$("#myflow").flow(["填写冻结申请","打印冻结申请凭证,并加盖公司印章","上传申请凭证的扫描图片"],3);
	$(function(){

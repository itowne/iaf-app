...
<%
response.setHeader("Content-Disposition", "attachment;filename=djpz.doc");
 %> 
<html>
<head>
...
<body>
  ...
  <div align="center" style="font-size:16px;font-weight: bold ;color:red;margin-top: 10px">请打印以下的冻结申请凭证单，并盖上贵公司的印章后，扫描成图片上传到汇融易平台</div>

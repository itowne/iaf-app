...
<div id="workframe-wrapper" class="clearfix">
  ...
  <div align="center" style="font-size:16px;font-weight: bold">冻结申请信息</div>
  <div id="content" class="report" align="center" style="margin-top: 20px">
    ...
    <tr>
     ...
     <tr>
    	...
    	<td class="data" colspan="3" style="text-align:left"><input type="text" name="overdue" id="overdue"/></td>
    </tr>
     <tr>
    ...
    <tr>
    	...
    	<td class="data" colspan="3" style="text-align:left"><textarea rows="3" cols="55" name="memo" id="memo"></textarea></td>
    </tr>
    </table>
...
$("#myflow").flow(["填写冻结申请","下载打印冻结申请凭证，并加盖公司印章","上传申请凭证的扫描图片"],1);
	$(function(){

...
<body>
		<div id="workframe-wrapper" class="clearfix">
			<div id="content" class="report">
				...
				<iframe id="loanFrame" name="loanFrame" marginheight="0" marginwidth="0" src="/inst/loanord/merchCreditReport" width="100%" align="middle" scrolling="no" frameborder="0"></iframe>
				</div>
			</div>
			<div id="button" style="display:none;margin:0px;padding: 0px;" align="center">
			<s:form action="instCollMerch">
				<s:submit cssClass="dark-btn" value="返    回"></s:submit>
			</s:form>
			</div>
		</div>

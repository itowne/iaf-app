	...
	<body>
		<div id="workframe-wrapper" class="clearfix">
			...
			<div id="content">
				...
				<s:form id="roleForm" action="/inst/instRole!instRoleAdd" onsubmit="return checkform();">
					<table id="addRole" width="80%" border="0" cellspacing="0" cellpadding="0" class="data-table">
						<tr>
							<td class="label">角色名称：</td>
							<td class="data"><s:textfield id="roleName" name="roleName" maxLength="30" onblur="check(this);"/><font color=red>*<s:property value="%{roleNameError}"/></font>
							<span id="msg"></span></td>
						</tr>
						<tr>
					...
					<div class="uop">
						<input type="submit" class="dark-btn"  value="确&nbsp;&nbsp;定"/> 

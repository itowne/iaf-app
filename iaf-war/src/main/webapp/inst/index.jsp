			...
			<header id="header">
				...
				<div id="guide">
					<ul>
						...
						<li class="help"><a href="/help/instIndex.jsp" target="_blank">帮&nbsp;助</a></li>
						<li class="logout"><a href="/instUserLogin!logout" target="_top">退&nbsp;出</a></li>
					</ul>
				</div>
				<div class="clear"></div>
			</header>

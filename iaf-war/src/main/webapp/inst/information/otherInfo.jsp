...
<body>
	...
	<script type="text/javascript">
		...
		function showUpload(id){
			//parent.jDialog("上传其他资料","${ctx}/inst/information/instInformation!LogoUpload?fileId="+id,800,500,true,function(){
				//logoFrame.parent.location = "${ctx}/inst/information/instInformation";
			//});
			window.location.href="${ctx}/inst/information/instInformation!otherModify?fileId="+id;
		}

...
<body>
		<div class="report" style="border: 0px">
					...
					<s:if test="#session.logoTFile.size<=0">
						<tr style="border: 0">
							<td class="data" width="650" style="text-align: center;border: 0px">
								&nbsp;
							</td>
						</tr>
					</s:if>
	...
	<script type="text/javascript">
		...
		function showUpload(id){
			//parent.jDialog("上传LOGO资料","${ctx}/inst/information/instInformation!LogoUpload?fileId="+id,800,500,true,function(){
				//logoFrame.parent.location = "${ctx}/inst/information/instInformation";
			//});
			window.location.href="${ctx}/inst/information/instInformation!modifyLogo?fileId="+id;
		}
		
		function deletePic(id){
			if(confirm("确认要删除此资料?")){
				window.parent.location.href="${ctx}/inst/information/instInformation!deletePic?ifile="+id;	
			}
		}
	</script>

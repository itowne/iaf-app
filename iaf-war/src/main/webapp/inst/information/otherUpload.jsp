...
<body>
		<div id="workframe-wrapper" class="clearfix">
			<s:form id="instinfoform" action="instInformation" namespace="/inst/information" enctype="multipart/form-data">
			<div id="content" class="report">
				<div class="report-tab-area">
					<div class="tab-content">
					<s:hidden name="filetype" value="instFile"/>
					<input type="hidden" name="fileId" value="<s:property value='%{fileId}'/>"/>
					<s:file id="upload" name="upload" value="选择图片文件"></s:file>
					<s:submit cssClass="dark-btn" value="修改文件" method="otherInfoUpdate" onclick="return checkForm()"/>
					<input type="button" class="dark-btn" value="取消" name="cel" onclick="cancel()"/>
					</div>
				</div>
			</div>
			</s:form>
